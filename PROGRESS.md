...
| 5 | Admin app | 🟡 in progress | — (template/rule building works end-to-end via UI; exit still needs pricing-config UI + live breakdown, which depends on the Phase 6 price endpoint) |
